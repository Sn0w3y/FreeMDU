# FreeMDU [![Build Status](https://img.shields.io/github/actions/workflow/status/Sn0w3y/FreeMDU-GUI/ci.yml)](https://github.com/Sn0w3y/FreeMDU-GUI/actions/workflows/ci.yml)
